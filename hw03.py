...
def pingpong(n):
    ...
    def count_eight(n):
        if n < 8:
            ...
            return 1 + count_eight(n-1)
        else:
            return count_eight(n-1)
    if count_eight(n) == 0:
        return n
    elif n <= 8:
        return n
    else:
        if count_eight(n) % 2 == 0:
...
def next_smaller_coin(coin):
    ...
    if coin == 25:
        ...
        return 5python3 ok -q count_coins
    elif coin == 5:
        return 1
...
def count_coins(change):
    ...
    def max_count(m, n):
        if m < 0:
            ...
            with_n = max_count(m-n, n)
            without_n = max_count(m, next_smaller_coin(n))
            return with_n + without_n
    return max_count(change, m_d)  
